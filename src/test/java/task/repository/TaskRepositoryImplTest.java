...
public class TaskRepositoryImplTest {
    ...
    void getById_Positive() {
        ...
        Document mockDoc = new Document("_id", id).append("title", "Test Task").append("description", "Description: ");
        Task mockTask = TaskBuilder.newTask().withTitle("Test Task").withDescription("Description: ").build();
